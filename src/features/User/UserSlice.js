...
export const fetchPotentialPeopleToFollowSearch = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/YetToFollow/${data.search}`,
      {
        method: "GET",
        headers: {
...
export const fetchPotentialPeopleToFollow = createAsyncThunk(
  ...
  async () => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/YetToFollow`,
      {
        method: "GET",
        headers: {
          Authorization: localStorage.getItem(`token`),
...
export const postFollowRequest = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/followRequest`,
      {
        method: "POST",
        headers: {
          Authorization: localStorage.getItem(`token`),
...
export const removeFollowRequest = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/removefollowRequest`,
      {
        method: "POST",
        headers: {
          Authorization: localStorage.getItem(`token`),
...
export const fetchUserDetails = createAsyncThunk(
  ...
  async (data) => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/${data.id}`,
      {
        method: "GET",
        headers: {
          Authorization: localStorage.getItem(`token`),
...
export const acceptFollowRequest = createAsyncThunk(
  ...
  async (data, { dispatch }) => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/user/addFollower`,
      {
        method: "POST",
        headers: {
          Authorization: localStorage.getItem(`token`),
...
export const fetchPosts = createAsyncThunk("fetch/Posts", async (data) => {
  const response = await fetch(
    `${import.meta.env.VITE_BACKEND}/api/v1/post/fetchPosts/${data.id}`,
    {
      method: "GET",
      headers: {
        Authorization: localStorage.getItem(`token`),
...
export const fetchBookMarks = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `${import.meta.env.VITE_BACKEND}/api/v1/bookmark/BookMarks/${data.id}`,
      {
        method: "GET",
        headers: {
          Authorization: localStorage.getItem(`token`),
